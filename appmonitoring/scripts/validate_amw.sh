...
verify_amw_metrics() {
    ...
    # Exclude metrics with sdk.version to ensure we're not looking at metrics forked by Breeze
    query="cows_sold_total{\"service.instance.id\"=\"$pod_name\",\"sdk.version\"=\"\"}"
