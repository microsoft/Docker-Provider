...
sudo curl -L -O https://github.com/microsoft/Docker-Provider/releases/download/otel-preview/azure-mdsd-1.37.0-pr.13360978.merge.5591.x86_64.rpm
sudo tdnf install -y --nogpgcheck azure-mdsd-1.37.0-pr.13360978.merge.5591.x86_64.rpm
