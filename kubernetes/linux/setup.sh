...
sudo curl -L -O https://github.com/microsoft/Docker-Provider/releases/download/mdsd-1.31.0/telegraf-agent-1.34.2-1.cm2.x86_64.rpm
sudo tdnf install -y --nogpgcheck telegraf-agent-1.34.2-1.cm2.x86_64.rpm
