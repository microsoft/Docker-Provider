...
sudo curl -L -O https://github.com/microsoft/Docker-Provider/releases/download/otel-preview/azure-mdsd-1.38.1-1209.x86_64.rpm
sudo tdnf install -y --nogpgcheck azure-mdsd-1.38.1-1209.x86_64.rpm
