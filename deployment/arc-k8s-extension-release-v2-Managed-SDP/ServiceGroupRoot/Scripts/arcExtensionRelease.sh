...
METHOD="${METHOD:-put}"
# The build packages the Helm chart and pushes it to the preview chart repo; the AKS prod release
...
REGISTRY_PATH_CANARY_STABLE="https://mcr.microsoft.com/azuremonitor/helmchart/containerinsights/ciprod/azuremonitor-containers"
