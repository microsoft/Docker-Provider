...
var sampleLog2 = NetworkFlowLog{
    ...
    SourceWorkloads:        `["k8s:pod-template-hash=5dcddfd57b","k8s:io.cilium.k8s.policy.serviceaccount=ama-logs","k8s:io.cilium.k8s.namespace.labels.control-plane=true","k8s:io.cilium.k8s.namespace.labels.kubernetes.io/cluster-service=true","k8s:io.kubernetes.pod.namespace=kube-system","k8s:io.cilium.k8s.namespace.labels.addonmanager.kubernetes.io/mode=Reconcile","k8s:rsName=ama-logs-rs","k8s:io.cilium.k8s.namespace.labels.kubernetes.azure.com/managedby=aks","k8s:io.cilium.k8s.namespace.labels.kubernetes.io/metadata.name=kube-system","k8s:io.cilium.k8s.policy.cluster=default"]`,
